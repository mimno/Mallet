...
public class DMRTopicModel extends ParallelTopicModel {
	...
	public void estimate () throws IOException {
		...
		DMRRunnable[] runnables = new DMRRunnable[numThreads];
		...
		if (numThreads > 1) {
			...
			for (int thread = 0; thread < numThreads; thread++) {
				...
				runnables[thread] = new DMRRunnable(numTopics, this, beta, random, data, runnableCounts, runnableTotals, offset, docsPerThread);
			...
			runnables[0] = new DMRRunnable(numTopics, this, beta, random, data, typeTopicCounts, tokensPerTopic, offset, docsPerThread);
